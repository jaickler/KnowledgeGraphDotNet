...
public interface IGraphWriter
{
    ...
    IEnumerable<GraphWriteOperation> WriteInformation(string information);
    ...
    IAsyncEnumerable<GraphWriteOperation> WriteInformationAsync(string information, CancellationToken token);
}